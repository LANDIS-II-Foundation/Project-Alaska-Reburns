...
C
C
C     THIS IS THE DRIVER FOR THE SHAW MODEL (VERSION 3.0.1)
C
...
C
     ...
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      REAL*8 LF,LV,LS
C
      REAL*8 SUNHOR(24),TMPDAY(24),WINDAY(24),HUMDAY(24),PRECIP(24),
     >     SNODEN(24),SOITMP(24),VLCDAY(24),SOILXT(50,24)
C
      REAL*8 PLTHGT(8),PLTWGT(8),PLTLAI(8),ROOTDP(8),DCHAR(8),
     >     TCCRIT(8),RSTOM0(8),RSTEXP(8),PLEAF0(8),RLEAF0(8),
     >     RROOT0(8),CANALB(8),PINTRCP(8),XANGLE(8),CLUMPNG(8),
     >     STOMATE(8,10)
      REAL*8 ZC(11),TCDT(11),TLCDT(8,10),VAPCDT(11),WCANDT(10)
      REAL*8 ZSP(100),DZSP(100),RHOSP(100),TSPDT(100),DLWDT(100)
      REAL*8 PCANDT(8),WLAG(11)
      REAL*8 ZR(10),RHOR(10),TRDT(10),VAPRDT(10),GMCDT(10)
C
      REAL*8 ZS(50),TSDT(50),MATDT(50),CONCDT(10,50),
     >     VLCDT(50),VICDT(50),SALTDT(10,50)
      REAL*8 DGRADE(10),SLTDIF(10),ASALT(50),DISPER(50)
C
...
C 
C JM **
c      WRITE(21, *) 'CALL GOSHAW, ISHITER = ', ISHITER
     ...
     >  SOILXT(1,HOUR),ISHITER)
C
      INITAL=1
C
C JM **
      IF (ISHITER .EQ. ISHITERMAX) THEN
         WRITE(21, *) 'STOPPED AFTER ISHITER = ', ISHITER
         STOP
      END IF
      ISHITER = ISHITER + 1
C JM
...
C
     ...
     >  ZMSRF,ZHSRF,ZERSRF,ZMSP,ZHSP,HEIGHT,POND,PONDMX,
     >  ALATUD,SLOPE,ASPECT,HRNOON,CLOUDS,DECLIN,HAFDAY,
     >  SUNHOR,TMPDAY,WINDAY,HUMDAY,PRECIP,SNODEN,SOITMP,VLCDAY,
     >  SOILXT,ISHITER)
C
C***********************************************************************
		IMPLICIT DOUBLE PRECISION (A-H, O-Z)
...
cxOUT
      REAL*8 LF,LV,LS,MELT
C
      REAL*8 SOILXT(50)
C
      REAL*8 DCHAR(8),CANALB(8),PINTRCP(8),XANGLE(8),CLUMPNG(8),
     >     RSTOM0(8),RSTEXP(8),PLEAF0(8),RLEAF0(8),RROOT0(8),
     >     STOMATE(8,10),ZC(11),TCCRIT(8)
      REAL*8 DGRADE(10),SLTDIF(10),ASALT(50),DISPER(50)
C
      REAL*8 LWCAN(9,10),LWSNOW,LWRES(10),LWSOIL,LWDOWN(11),LWUP(11),
     >     SWCAN(9,10),SWSNOW(100),SWRES(10),SWDOWN(11),SWUP(11)
      REAL*8 ZS(50),TS(50),TSDT(50),MAT(50),MATDT(50),CONC(10,50),
     ...
     >     TOTLAT(50)
      REAL*8 BTS(50),BMAT(50),BCONC(10,50),BVLC(50),BVIC(50)
      REAL*8 RHOR(10),ZR(10),BSALT(10,50)
      REAL*8 TR(10),TRDT(10),VAPR(10),VAPRDT(10),GMC(10),GMCDT(10),
     >     UR(10),SR(10),QVR(10)
      REAL*8 BTR(10),BVAPR(10),BGMC(10)
      REAL*8 TC(11),TCDT(11),TLC(8,10),TLCDT(8,10),VAPC(11),VAPCDT(11),
     >     WCAN(10),WCANDT(10),PCAN(8),PCANDT(8),TRNSP(9),UC(10),SC(10),
     >     PLTHGT(8),PLTWGT(8),PLTLAI(8),ROOTDP(8),QVC(10)
      REAL*8 BTC(11),BTLC(8,10),BVAPC(11),BWCAN(10),BPCAN(8)
      REAL*8 ZSP(100),DZSP(100),RHOSP(100)
      REAL*8 TSP(100),TSPDT(100),DLW(100),DLWDT(100),USP(100),SSP(100),
     >     QVSP(100),TQVSP(100),WLAG(11)
      REAL*8 BTSP(100),BDLW(100)
      REAL*8 DELTA(150),DELNRG(150),DELWTR(150)
C
...
C
      SAVE NPRINT,MAXSTP,MINSTP,MELT
      DATA NPRINT/ 0/ MAXSTP/ 0/ MINSTP/ 0/
C
C
C JM **
C      write (21, *) 'ishiter = ', ishiter
C
      IF (INITAL .EQ. 0) THEN
...
C           DETERMINE ROOT DISTRIBUTION (IF NOT DEFINED BY USER)            
     ...
     >         CALL RTDIST (NPLANT,ITYPE,NS,ZS,ROOTDP,RROOT0,ISHITER)
           ELSE
            NC=0
            NCMAX=0
         END IF
...
C              CANOPY IS OVERLYING BARE SOIL
     ...
     >        ITYPE,ISTOMATE,STOMATE,ITER,ISHITER)
         MATERL = MATERL + 1
      END IF
C
...
C-----------------------------------------------------------------------
      IF (LEVEL(1) .GE. 2) THEN
         ...
         WRITE (21,991) (QSV(K), K=1,NS-1)
         WRITE (21,*) ' LIQUID FLUXES (M/S)'
         WRITE (21,991) (QSL(K), K=1,NS-1)
         WRITE (21,*) ' JACOBIAN MATRIX'
         DO 215 K=1,N
            WRITE (21,992) A1(K),B1(K),C1(K),D1(K)
  215    CONTINUE
         WRITE (21,*)
...
C JM **	
  991    FORMAT (5E15.6,/5E15.6,/5E15.6,/5E15.6)
  992    FORMAT (5G14.6,/5G14.6,/5G14.6,/5G14.6)
  993    FORMAT (A15,/5E15.6,/5E15.6,/5E15.6,/5E15.6
     >   ,/5E15.6,/5E15.6,/5E15.6,/5E15.6,/5E15.6)
C JM
C-----------------------------------------------------------------------
C
...
C           TO SUPPRESS TENDENCY TO JUMP BACK AND FORTH AROUND SOLUTION
         ...
         IF (LEVEL(1) .GE. 2) WRITE (21,992) DELTA(N),TCDT(I),VAPCDT(I),
     >                                    WCANDT(I)
         N=N+1
  220 CONTINUE
      MATERL=MATERL+1
...
CCCC           TSPDT(I) = RHOL*LF*DLWDT(I)/(RHOI*CI)
            ...
            END IF
         END IF
         IF (LEVEL(1) .GE. 2) WRITE (21,992) DELTA(N),TSPDT(I),DLWDT(I),
     >                                  DZSP(I)
         N=N+1
  230 CONTINUE
      MATERL=MATERL+1
...
C           TO SUPPRESS TENDENCY TO JUMP BACK AND FORTH AROUND SOLUTION
         ...
         IF (LEVEL(1) .GE. 2) WRITE (21,992) DELTA(N),TRDT(I),VAPRDT(I),
     >                                    GMCDT(I)
         N=N+1
  240 CONTINUE
      MATERL=MATERL+1
...
C              REDEFINE MATRIC POTENTIAL
     ...
     >            CALL MATVL1 (I,MATDT(I),VLCDT(I),DUMMY)
         ...
         END IF
C
         IF (LEVEL(1) .GE. 2) WRITE (21,992) DELTA(N),TSDT(I),VLCDT(I),
...
C-----------------------------------------------------------------------
      IF (LEVEL(1) .GE. 2) THEN
         ...
         WRITE (21,*) ' JACOBIAN MATRIX'
         DO 305 I=1,N
            WRITE (21,992) A2(I),B2(I),C2(I),D2(I)
  305    CONTINUE
         WRITE (21,*)
...
C           TO SUPPRESS TENDENCY TO JUMP BACK AND FORTH AROUND SOLUTION
         ...
         IF (LEVEL(1) .GE. 2) WRITE (21,992) DELTA(N),VAPCDT(I),TCDT(I),
     >                                    WCANDT(I)
         N=N+1
  310 CONTINUE
      MATERL=MATERL+1
...
C           TO SUPPRESS TENDENCY TO JUMP BACK AND FORTH AROUND SOLUTION
         ...
         IF (LEVEL(1) .GE. 2) WRITE (21,992) DELTA(N),VAPRDT(I),TRDT(I),
     >                                    GMCDT(I)
         N=N+1
  320 CONTINUE
      MATERL=MATERL+1
...
C              TO SUPPRESS TENDENCY TO JUMP AROUND SOLUTION
         ...
         IF (LEVEL(1) .GE. 2) WRITE (21,992) DELTA(N),MATDT(I),VLCDT(I),
     >                                    VICDT(I)
         N=N+1
  330 CONTINUE
...
cxOUT
     ...
     >   ISNOTMP,SNOTMP,SNODEN,DIRRES,SLOPE,ISHITER)
C
...
C        PRINT OUTPUT TO SCREEN
         IF (LVLOUT(20) .NE. 0) THEN
            ...
            IF (MOD(NPRINT,LVLOUT(20)).EQ.0) THEN
               WRITE (21,530) JULIAN,HOUR,YEAR,MINSTP,MAXSTP
...
C***********************************************************************
     ...
     >                IEVAP(8),RLEAF(8,10),RROOT(8,50),ROOTDN(8,50),
     >                TOTROT(8)
      COMMON /SPPROP/ G1,G2,G3,EXTSP,TKSPA,TKSPB,TKSPEX,VDIFSP,VAPSPX
      COMMON /SPWATR/ CLAG1,CLAG2,CLAG3,CLAG4,PLWMAX,PLWDEN,PLWHC,
     >                THICK,CTHICK
...
C
C
      REAL*8 ZS(50),TSDT(50),MATDT(50),CONCDT(10,50),VLCDT(50),
     >     SALTDT(10,50),VICDT(50)
      REAL*8 GMCDT(10)
      REAL*8 TSPDT(100),DLWDT(100)
      REAL*8 WCANDT(10)
      REAL*8 HEIGHTS(10)
      REAL*8 PLTHGT(8),PLTWGT(8),PLTLAI(8),ROOTDP(8)
...
C        DETERMINE MAXIMUM WATER CONTENT OF STANDING DEAD (AT 99.9% RH)
         CALL CANHUM (2,0.999D0,DUMMY,WCMAX,0.0D0,CANMA,CANMB)
...
C        DETERMINE MAXIMUM WATER CONTENT OF RESIDUE (AT 99.9% RH)
         CALL RESHUM (2,0.999D0,DUMMY,GMCMAX,0.0D0)
         IF (IVERSION .EQ. 2) THEN
...
C***********************************************************************
      ...
      REAL*8 SUNHOR(24),TMPDAY(24),WINDAY(24),HUMDAY(24),PRECIP(24),
     >    SNODEN(24),SOITMP(24),VLCDAY(24),SOILXT(50,24)
      REAL*8 VLC1(50),TMP1(50),FLUX(50)
      REAL*8 PLTHGT(8),DCHAR(8),CLUMPNG(8),PLTWGT(8),PLTLAI(8),
...
C
      ...
      COMMON /SWRCOE/ SOLCON,DIFATM,DIFRES,SNOCOF,SNOEXP
C
      REAL*8 SUNHOR(24),TMPDAY(24),HUMDAY(24),WINDAY(24),
...
cxOUT
      ...
      REAL*8 PLTHGT(8),PLTWGT(8),PLTLAI(8),ZSP(100),RLEAF0(8),ZC(11),
     >     TC(11),TCDT(11),TLC(8,10),TLCDT(8,10),VAPC(11),VAPCDT(11),
     >     WCAN(10),WCANDT(10),PCANDT(8)
      REAL*8 ZZC(11),DZCAN(10),DDRYCAN(8,10),CCANLAI(8,10),
     >     PLANTW(8),TMP(8)
      INTEGER ITYPE(8)
...
C***********************************************************************
		IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      REAL*8 ZC(11),WCANDT(10),TCDT(11),TLCDT(8,10),VAPCDT(11),
     >     PLANTZ(8),PLTHGT(8),PLANTW(8),TOTLAI(8),PLTLAI(8),RLEAF0(8)
      REAL*8 DRYCAN(8,10),CANLAI(8,10),RLEAF(8,10)
      REAL*8 LAISUM,LAILYR,LYRTOP,LYRTOT,DZMAX,A,DZ(10),
     >     FACTOR,TMPLAI
C
...
C***********************************************************************
		IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      REAL*8 ZC(11),ZZC(11),WCANDT(10),TCDT(11),TLCDT(8,10),VAPCDT(11),
     >     PLANTZ(8),PLANTW(8),TOTLAI(8),RLEAF0(8),
     >     DRYCAN(8,10),CANLAI(8,10),RLEAF(8,10)
      REAL*8 ZMID(10)
      REAL*8 LYRTOP,LYRBTM
...
C***********************************************************************
C
      SUBROUTINE RTDIST (NPLANT,ITYPE,NS,ZS,ROOTDP,RROOT0,ISHITER)
C
...
C***********************************************************************
     ...
     >                IEVAP(8),RLEAF(8,10),RROOT(8,50),ROOTDN(8,50),
     >                TOTROT(8)
      REAL*8 ZS(50),ROOTDP(8),RROOT0(8)
      INTEGER ITYPE(8)
C
      DATA RMXDEN/ 0.1/
C
...
C***********************************************************************
     ...
     >                CM,COM,CA,CV,CR,VONKRM,VDIFF,PRESUR,P0,
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      REAL*8 TRDT(10),VAPRDT(10),GMCDT(10),RHOR(10),ZR(10)
      REAL*8 TSDT(50),MATDT(50),CONCDT(10,50)
      REAL*8 LF,LV,LS
C
...
C
      REAL*8 SWCAN(9,10),SWSNOW(100),SWRES(10),SWDOWN(11),SWUP(11),
...
C     DEFINE THE DIFFUSE RADIATION TRANSMISSION FOR LONG-WAVE BALANCE           
     ...
     >                            DIFKL,DIRKL,FBDU,FDDU,0.0D0,0.0D0)
C                                                                               
C     SNOWPACK NODES                                                            
      DO 80 I=1,NSP                                                             
         SWSNOW(I)=0.0                                                          
...
C     DEFINE THE DIFFUSE RADIATION TRANSMISSION FOR LONG-WAVE BALANCE 
      C785 = 0.785          
      IF (NR .GT. 0) CALL TRANSR (NR,TDIREC,TDIFFU,ZR,RHOR,C785,DIRRES)                       
C                                                                               
C     SOIL SURFACE                                                              
      SWSOIL=0.0                                                                
C                                                                               
...
C
      REAL*8 LF,LS,LV
C
      REAL*8 SWSNOW(100),RHOSP(100),DZSP(100)
C
...
C***********************************************************************        
     ...
     >                FBDU(8),FDDU(8)
      COMMON /RADRES/ TDIREC(10),TDIFFU(10)
C
      REAL*8 SWCAN(9,10),SWRES(10),SWDOWN(11),SWUP(11),
...
C***********************************************************************
     ...
     >                TOTROT(8)
C
      REAL*8 XANGLE(8),CLUMPNG(8),TDIRCC(10),TDIFFC(10),
     >     DIRKL(9,10),DIFKL(9,10),FBDU(8),FDDU(8)
C
      REAL*8 DIRCAN(8),DIFCAN(8)
...
C***********************************************************************
      ...
      COMMON /SWRCOE/ SOLCON,DIFATM,DIFRES,SNOCOF,SNOEXP
C
      REAL*8 TDIREC(10),TDIFFU(10),ZR(10),RHOR(10)
...
C***********************************************************************
		IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      REAL*8 A(42),B(42),C(42),D(42),RD(21),RU(21)
C
      DO 40 N=1,NLAYR
...
C***********************************************************************
		IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      REAL*8 TS(50),TSDT(50),MAT(50),MATDT(50),CONC(10,50),
     >     VLC(50),VLCDT(50),VIC(50),VICDT(50),SALT(10,50)
      REAL*8 TR(10),TRDT(10),VAPR(10),VAPRDT(10),GMC(10),GMCDT(10)
      REAL*8 SALTDT(10,50)
      REAL*8 TC(11),TCDT(11),TLC(8,10),TLCDT(8,10),VAPC(11),VAPCDT(11),
     >     WCAN(10),WCANDT(10),PCAN(8),PCANDT(8),CONCDT(10,50)
      REAL*8 TSP(100),TSPDT(100),DLW(100),DLWDT(100)
...
C
      ...
      REAL*8 TLC(8,10),TLCDT(8,10),TSP(100),TSPDT(100),TR(10),TRDT(10),                 
...
C***********************************************************************
     ...
     >                FBDU(8),FDDU(8)
      COMMON /RADRES/ TDIREC(10),TDIFFU(10)
      REAL*8 TLC(8,10),TLCDT(8,10),TR(10),TRDT(10),LWCAN(9,10),
     >     LWDOWN(11),LWUP(11),LWRES(10)
      REAL*8 A(42),B(42),C(42),D(42),RD(21),RU(21),DDU(10)
C
C     INITIALIZE MATRIX ELEMENTS
      N = 1
      A(1) = 0.0
...
C***********************************************************************
     ...
     >                FBDU(8),FDDU(8)
      COMMON /RADRES/ TDIREC(10),TDIFFU(10)
      REAL*8 TC(11),TSP(100),TR(10),TS(50)
      INTEGER ICESPT(100)
C
      N = 1
      MATERL=2
...
C***********************************************************************
		IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      REAL*8 UC(10),SC(10),USP(100),SSP(100),UR(10),SR(10),US(50),
...
C
      IF (ITER .LE. 2) THEN
         IF (ITER .LE. 1) THEN
            ...
            IF (NC .GT. 0) ZCLOG=LOG((ZC(NC+1)-ZERO+ZH)/ZH)
         END IF
...
cxOUT
      ...
      REAL*8 LF,LS,LV
C
      REAL*8 ZC(11),TC(11),TCDT(11),TLC(8,10),TLCDT(8,10),
     >     VAPC(11),VAPCDT(11),WCAN(10),WCANDT(10),PCAN(8),PCANDT(8),
     >     MAT(50),MATDT(50),SWCAN(9,10),LWCAN(9,10),SWDOWN(11)
      REAL*8 DCHAR(8),RSTOM0(8),RSTEXP(8),PLEAF0(8),RLEAF0(8),
     >     STOMATE(8,10)
      REAL*8 CON(10),CONT(10),CONDT(10),
...
C**** CALCULATE LEAF TEMPERATURE AND HEAT TRANSFER FROM CANOPY
     ...
     > RLEAF0,ISTOMATE,STOMATE,DHEATC,DTLDTC,ISHITER)
C
...
C
     ...
     > RSTEXP,PLEAF0,RLEAF0,ISTOMATE,STOMATE,DHEATC,DTLDTC,ISHITER)
C
...
C
     ...
     >     HEATC(10),ETLYR(10),DETLYR(10),DHEATC(10),DTLDTC(10)
      REAL*8 DCHAR(8),RSTOM0(8),RSTEXP(8),PLEAF0(8),RLEAF0(8),
     >     STOMATE(8,10)
      REAL*8 AVGTMP(10),AVGVAP(10),AVGDEF(10),RSTOM(10),PLEAF(10),
     >     PEVAP(10),PXYLEM(8),RHCAN(8,10),RVCAN(8,10),ETCAN(8,10),
     >     AVGMAT(50),HUMID(10),VTSLOP(10)
      REAL*8 F1(10),DF1DP(10),DF1DT(10),DF1DX(10),DP(10),AA1(10),
...
C***********************************************************************
     ...
     >                CM,COM,CA,CV,CR,VONKRM,VDIFF,PRESUR,P0,
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      REAL*8 RSTOM0(8),RSTEXP(8),PLEAF0(8),STOMATE(8,10)
C
      IF (ISTOMATE .EQ. 2) THEN
...
C           USE GROUND USTAR AT SURFACE
            IF (ITER .LE. 1) THEN
               ZMLOG=LOG((ZC(NC+1)-ZC(NC)+ZMSUB-ZERSUB)/ZMSUB)
            END IF
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      COMMON /MATRIX/ A1(150),B1(150),C1(150),D1(150),
     >                A2(150),B2(150),C2(150),D2(150)
      REAL*8 TSP(100),TSPDT(100),DLW(100),DLWDT(100),RHOSP(100),
     >     ZSP(100),DZSP(100),QVSP(100),SSP(100)
      REAL*8 QVSPT(100),QVSPDT(100),TK(100),CON(100),CONV(100),
     >     CSP(100),CSPT(100),CSPDT(100),SLOPE(100)
      INTEGER ICESPT(100)
      REAL*8 LF,LS,LV
      SAVE QVSPT,CON,CSPT
C
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      COMMON /SPPROP/ G1,G2,G3,EXTSP,TKSPA,TKSPB,TKSPEX,VDIFSP,VAPSPX
      REAL*8 QVSP(100),TSP(100),ZSP(100),VAPSNO(100),
...
C***********************************************************************
     ...
     >                CM,COM,CA,CV,CR,VONKRM,VDIFF,PRESUR,P0,
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      REAL*8 CSP(100),TSP(100),RHOSP(100)
      REAL*8 LF,LS,LV
C
      DO 10 I=1,NSP
...
C***********************************************************************
     ...
     >                A2(150),B2(150),C2(150),D2(150)
      ...
      REAL*8 LF,LS,LV
C
      REAL*8 ZR(10),TR(10),TRDT(10),VAPR(10),VAPRDT(10),GMC(10),
     >     RHOR(10),SR(10),UR(10),QVR(10),RHOSP(100),GMCDT(10)
      REAL*8 CRES(10),CREST(10),CRESDT(10),TKRES(10),CONVEC(10),
...
C***********************************************************************
      ...
      COMMON /TIMEWT/ WT,WDT,DT
C
      REAL*8 EVAP(10),EVAPK(10),ZR(10),TR(10),TRDT(10),VAPR(10),
...
C***********************************************************************
     ...
     >               ZMSUB,ZHSUB,ZERSUB,WINDC(11),WINDR(10)
      REAL*8 LF,LS,LV
C
      REAL*8 TR(10),TRDT(10),GMC(10),GMCDT(10),RHOR(10),RHOSP(100)
      REAL*8 CONVEC(10),TKRES(10),TKSP(100)
      DATA RESDEN/ 170./ 
C
      IF (NSP .GT. 0) THEN
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      COMMON /SPPROP/ G1,G2,G3,EXTSP,TKSPA,TKSPB,TKSPEX,VDIFSP,VAPSPX
      REAL*8 CONVEC(10),VAPCON(10),TR(10),TRDT(10)
      REAL*8 LF,LS,LV
C
      DO 10 I=1,NR
...
C***********************************************************************
		IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      COMMON /TIMEWT/ WT,WDT,DT
      REAL*8 QVR(10),CONV(10),VAPR(10),VAPRDT(10)
C
      DO 10 I=1,NR
...
C***********************************************************************
     ...
     >                NSALT,SALTKQ(10,50),VAPCOF(50),VAPEXP(50),
     >                ROCK(50),SAND(50),SILT(50),CLAY(50),OM(50),IWRC
      REAL*8 QSV(50),ZS(50),TS(50),MAT(50),VLC(50),VIC(50),CONC(10,50)
      REAL*8 HUMID(50),DVT(50),DVP(50),CONVT(50),CONVP(50),DCONVP(50)
      REAL*8 LF,LS,LV
C
      DO 20 I=1,NS
...
C***********************************************************************
     ...
     >     CON(50),CST(50),CSDT(50),HKT(50),HKDT(50),CONH(50),
...
C***********************************************************************
     ...
     >                ROCK(50),SAND(50),SILT(50),CLAY(50),OM(50),IWRC
      REAL*8 LF,LV,LS
C
      REAL*8 CS(50),VLC(50),VIC(50),TS(50),MAT(50),CONC(10,50)
C
      DO 20 I=1,NS
...
C***********************************************************************
     ...
     >                NSALT,SALTKQ(10,50),VAPCOF(50),VAPEXP(50),
     >                ROCK(50),SAND(50),SILT(50),CLAY(50),OM(50),IWRC
      REAL*8 MAT(50),CONC(10,50),VLC(50)
      REAL*8 LF,LS,LV
C
      CNCGAS=0.0
      CRT=0.0
...
C***********************************************************************
     ...
     >                NSALT,SALTKQ(10,50),VAPCOF(50),VAPEXP(50),
     >                ROCK(50),SAND(50),SILT(50),CLAY(50),OM(50),IWRC
      REAL*8 VLC(50),VIC(50),MAT(50),CONC(10,50),TS(50),SALT(10,50)
      INTEGER ICES(50)
      REAL*8 LF,LS,LV
      REAL*8 MAT1
C
...
C***********************************************************************
     ...
     >                ROCK(50),SAND(50),SILT(50),CLAY(50),OM(50),IWRC
      COMMON /SPHEAT/ CS(50)
      REAL*8 VICDT(50),VLCDT(50),MATDT(50),CONCDT(10,50),
...
cxOUT
      ...
      REAL*8 LF,LS,LV
C
      REAL*8 ZC(11),TC(11),TCDT(11),TLC(8,10),TLCDT(8,10),VAPC(11),
...
C**** CALCULATE TRANSPIRATION FROM CANOPY
     ...
     > WCAN,WCANDT,PCAN,PCANDT,MAT,MATDT,TRNSP,XTRACT,SWCAN,LWCAN,
     > SWDOWN,HEATC,ETLYR,DETLYR,CANMA,CANMB,DCHAR,RSTOM0,RSTEXP,PLEAF0,
     > RLEAF0,ISTOMATE,STOMATE,DHEATC,DTLDTC,0)
C
C**** DETERMINE THE EDDY CONDUCTANCE TERM BETWEEN NODES
      CALL CANTK (ITER,NC,CON,TCDT,ZC)
C
...
C***********************************************************************
     ...
     >                A2(150),B2(150),C2(150),D2(150)
      ...
      REAL*8 LF,LS,LV
C
      REAL*8 ZSP(100),QVSP(100),TSPDT(100),TSDT(50)
C
...
C***********************************************************************
     ...
     >                A2(150),B2(150),C2(150),D2(150)
      REAL*8 LF,LS,LV
C
      REAL*8 ZS(50),MAT(50),MATDT(50),VLC(50),VLCDT(50),VIC(50),
...
C***********************************************************************
     ...
     >                NSALT,SALTKQ(10,50),VAPCOF(50),VAPEXP(50),
     >                ROCK(50),SAND(50),SILT(50),CLAY(50),OM(50),IWRC
      REAL*8 HK(50),MAT(50),VLC(50),VIC(50)
      REAL*8 LF,LS,LV
C
...
C***********************************************************************
      IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      REAL*8 QSL(50),ZS(50),CON(50),MAT(50)
C
      DO 10 I=1,NS-1
...
C***********************************************************************
     ...
     >     VLC(50),VLCDT(50),VIC(50),VICDT(50),SALT(10,50)
      ...
      REAL*8 TC(11),TCDT(11),TLC(8,10),TLCDT(8,10),VAPC(11),VAPCDT(11),
     >     WCAN(10),WCANDT(10),PCAN(8),PCANDT(8),CONCDT(10,50)
      REAL*8 TSP(100),TSPDT(100),DLW(100),DLWDT(100),SALTDT(10,50)
      INTEGER ICES(50),ICESDT(50),ICESP(100),ICESPT(100)
C
C     SOIL PROPERTIES
      DO 15 I=1,NS
...
C
      REAL*8 DGRADE(10),SLTDIF(10),ASALT(50),DISPER(50)
      REAL*8 ZS(50),CONC(10,50),CONCDT(10,50),SALT(10,50),
     >     VLC(50),VLCDT(50),TS(50),TSDT(50),QSL(50),XTRACT(50),
     >     SINK(10,50),DIFF(50),DIFFT(50),DIFFDT(50),CON(50),
     >     A3(50),B3(50),C3(50),D3(50),DELTA(50),EPSLON(50)
      REAL*8 SALTDT(10,50),CONCNW(50)
C
...
C***********************************************************************
      ...
      COMMON /TIMEWT/ WT,WDT,DT
C
      REAL*8 ZS(50),DIFF(50),VLC(50),VLCDT(50),TS(50),QSL(50),
     >     ASALT(50),DISPER(50),CON(50),SLTDIF(10)
C****
...
C
     ...
     >     SWCAN(9,10),SWSNOW(100),SWRES(10),SWDOWN(11),SWUP(11)
C
      REAL*8 QVC(10),QVR(10),QVSP(100),QSL(50),QSV(50),TRNSP(9),
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      REAL*8 LF,LS,LV
C
      REAL*8 ZC(11),WCANDT(10),PCANDT(8),PINTRCP(8),XANGLE(8),
     ...
     >   SALTDT(10,50),CONCDT(10,50),CLUMPNG(8)
      REAL*8 MELT
...
C
     ...
     >  GMCDT,RHOR,ZS,VLCDT,VICDT,TSDT,MATDT,CONCDT,ISHITER)
C
...
C***********************************************************************
     ...
     >                THICK,CTHICK
      REAL*8 LF,LS,LV
C
      REAL*8 ZSP(100),DZSP(100),RHOSP(100),TSPDT(100),DLW(100),
     >  TQVSP(100),DLWDT(100)
      REAL*8 ZC(11),PCANDT(8)
      REAL*8 ZR(10),GMCDT(10),TRDT(10),RHOR(10),CRES(10)
      REAL*8 ZS(50),VLCDT(50),VICDT(50),TSDT(50),MATDT(50),
     >     CS(50),CONCDT(10,50)
      INTEGER ICESPT(100)
      REAL*8 MELT
C
...
C***********************************************************************
     ...
     >                THICK,CTHICK
      REAL*8 LF,LS,LV
C
      REAL*8 RHOSP(100),DZSP(100),ZSP(100),TSPDT(100),DLW(100),
     >  TQVSP(100),WLAG(11),DLWDT(100)
      INTEGER ICESPT(100)
C
      SCOUT = 0.0
C
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      COMMON /METASP/ CMET1,CMET2,CMET3,CMET4,CMET5,SNOMAX
      REAL*8 TSPDT(100),RHOSP(100),DZSP(100),DLWDT(100)
      REAL*8 LF,LS,LV
C
...
C***********************************************************************
     ...
     >                THICK,CTHICK
      REAL*8 LF,LS,LV
C
      REAL*8 DZSP(100),RHOSP(100),TSPDT(100),DLWDT(100),WLAG(11)
      INTEGER ICESPT(100)
	  REAL DT8
      SAVE IFIRST,NLAG
      DATA IFIRST/0/
...
C     EMPIRICAL LAG AND ATTENUATION EQUATIONS - ONE HOUR TIME STEP USED.
      ...
      IDT=DT/3600.
      DT8 = DT
      IF (AMOD(DT8,3600.).GT.0.00001) IDT=IDT+1
      IF (IDT .EQ. 0) IDT=1
      HOURS=1.0
C
      DENSE = WE/TDEPTH
...
C***********************************************************************
     ...
     >                TOTROT(8)
C
      REAL*8 PCANDT(8),PINTRCP(8),XANGLE(8),CLUMPNG(8),WCANDT(10),
     >     TDIRCC(10),TDIFFC(10),DIRKL(9,10),DIFKL(9,10),FBDU(8)
      REAL*8 LF,LS,LV,FDDU(8)
      REAL*8 MAXINT
      INTEGER ITYPE(8)
C
...
C***********************************************************************
     ...
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
      REAL*8 LF,LS,LV
C
      REAL*8 ZR(10),TRDT(10),GMCDT(10),RHOR(10),TDIREC(10),TDIFFU(10),
     >  CRES(10)
C
C     USE THE TRANSMITTANCE TO DIRECT RADIATION TO CALCULATE THE
...
C***********************************************************************
     ...
     >                ROCK(50),SAND(50),SILT(50),CLAY(50),OM(50),IWRC
      REAL*8 LF,LS,LV
C
      REAL*8 ZS(50),TSDT(50),VLCDT(50),VICDT(50),MATDT(50),
     >     TOTFLO(50),SALTDT(10,50),CONCDT(10,50),SATKMX(50),
     >     CS(50),MATRIC(50)
      INTEGER ICESDT(50)
      REAL*8 INFMAX,INFIL,PSAT(50),VLC9(50),MAT9(50),SATK9(50)
C
C JM **  I added this save since PSAT should be initialized to 0.9 only at compilation, but it is changed later.
      SAVE PSAT
...
C              BETWEEN KNOWN POINTS OF VLC AND CONDUCTIVITY
               PSAT(I)=10.**(LOG10(PSATK)*
     >             LOG10(SATINF/SATKMX(I))/LOG10(SATK9(I)/SATKMX(I)))
...
C***********************************************************************
     ...
     >                IEVAP(8),RLEAF(8,10),RROOT(8,50),ROOTDN(8,50),
     >                TOTROT(8)
      REAL*8 LF,LS,LV,MELT
C
      REAL*8 ZC(11),WCAN(10),WCANDT(10),PCAN(8),PCANDT(8),VAPC(11),
...
C
  ...
  111 FORMAT (1X,I3,I3,I5,12(1X,F12.7),1X,F7.1,1X,F7.2)
      END
C***********************************************************************
C
...
C
C JM ** Looks like these need to be SAVES also:
      SAVE SWDOWN,LWDOWN,SWUP,LWUP
...
C
     ...
     >     MATDT(50),TOTFLO(50),TOTLAT(50),CONCDT(10,50),SALTDT(10,50)
      REAL*8 ROOTXT(50)
      REAL*8 AVGTMP(50),AVGMAT(50),AVGVLC(50),AVGVWC(50),AVGSLT(10,50),
     >     AVGCON(10,50),SUMFLO(50),SUMRXT(50),SUMLAT(50),HUMID(10)
cxOUT
      real*8 swdown(11),swup(11),lwdown(11),lwup(11)
     ...
     >     PRTZERO7,PRTZERO8,PRTZERO19,AVGVWC
C
...
C
  ...
  150 FORMAT (I4,I3,I5,F6.3,F7.3,F10.6,F7.3,1X,8F10.6)
C  150 FORMAT (I4,I3,I5,F6.3,F7.3,F10.6,F7.3,1X,8F6.2)
...
C***********************************************************************
		IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      REAL*8 ZSP(100),TSPDT(100)
      REAL*8 height(100),temp10(100)
      INTEGER HOUR,YEAR
C
      IF (INITAL .EQ. 0) THEN
...
C
     ...
     >                TKL,TKI,TKA,TKR,TKRO,TKSA,TKSI,TKCL,TKOM
C
      REAL*8 ZSP(100),RHOSP(100),DZSP(100),DLWDT(100),WLAG(11),
